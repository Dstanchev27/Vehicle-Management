    ...
    public class ServiceRecordSeeding : ISeeder
    {
        public async Task SeedAsync(ApplicationDbContext dbContext)
        {
            ...
            var serviceRecords = new List<ServiceRecord>
            {
                new ServiceRecord
                {
                    ServiceDate = DateTime.Now.AddMonths(-6),
                ...
                new ServiceRecord
                {
                    ServiceDate = DateTime.Now.AddMonths(-5),
                ...
                new ServiceRecord
                {
                    ServiceDate = DateTime.Now.AddMonths(-4),
                ...
                new ServiceRecord
                {
                    ServiceDate = DateTime.Now.AddMonths(-3),
                ...
                new ServiceRecord
                {
                    ServiceDate = DateTime.Now.AddMonths(-2),
                ...
                new ServiceRecord
                {
                    ServiceDate = DateTime.Now.AddMonths(-1),
